const TermsAndConditions = () => (
  <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16 max-w-4xl bg-white">
    ...
    <p className="text-sm sm:text-base leading-relaxed">
      ...
      5.9. Where the Client requires a purchase order number to be quoted on invoices raised by KeepMe Lifestyle Ltd then work will not be commenced by KeepMe Lifestyle Ltd until a purchase order document and number has been received by KeepMe Lifestyle Ltd in accordance with the agreed price estimate.<br/>
    ...
    <p className="text-sm sm:text-base leading-relaxed">
      ...
      7.3. The Client:<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;7.3.1 will not use the Intellectual Property Rights for any other purpose other than as set out in clause 7.2<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;7.3.2 will not modify the Intellectual Property Rights<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;7.3.3 may not assign, sublicense or deal with the Intellectual Property Rights<br/>
      7.4. KeepMe Lifestyle Ltd will retain the Intellectual Property Rights in any Works created by it in the course of carrying out the Works but not forming part of the final product of the Works as applied commercially by the Client.<br/>
      7.5. KeepMe Lifestyle Ltd shall take all reasonable care to ensure that no work proposed or submitted infringes any existing United Kingdom patent, design right, registered design, trade mark, or other intellectual property right of a third party. It does not warrant or give any representation that any such work will not infringe any such right. KeepMe Lifestyle Ltd shall be under no liability to the Client for any actions, costs, claims or demands suffered by the Client in respect of any infringement of any third party patent, trademark, trade name, registered design, or device for the protection of intellectual property, or in respect of passing-off, save insofar as such infringement is due to the negligence of KeepMe Lifestyle Ltd.<br/>
      7.6. All rights and interest in any patent, patentable invention or process, design right or registered design arising from the Works will be owned by and retained by KeepMe Lifestyle Ltd unless specifically agreed otherwise with the Client. KeepMe Lifestyle Ltd may at its own option and expense file or make any necessary application to protect such rights.<br/>
      7.7. Intellectual Property and Trademark Responsibility<br/>
      Clients are solely responsible for ensuring that any logos, brand guidelines, or related materials, whether provided by the Client or created by KeepMe Lifestyle Ltd, do not infringe upon existing trademarks, copyrights, or other intellectual property rights. Prior to using or registering any branding elements, clients should conduct thorough searches and, if necessary, consult with legal professionals to confirm that their use does not violate any third-party rights.<br/>
      7.8. No Warranty or Guarantee<br/>
      KeepMe Lifestyle Ltd does not guarantee that the designs and branding materials provided will be free from similarities to existing trademarks or copyrighted materials. Any resemblance to existing brands or logos is purely coincidental, and KeepMe Lifestyle Ltd disclaims any liability arising from such similarities.<br/>
      7.9. Indemnification<br/>
      Clients agree to indemnify and hold harmless KeepMe Lifestyle Ltd, its affiliates, and partners from any claims, damages, or legal actions arising from the use of the provided branding content, including but not limited to trademark infringement, copyright violations, or misrepresentation.<br/>
      7.10. Compliance with Branding Guidelines<br/>
      When incorporating references to third-party platforms or tools, clients must adhere to the respective branding and usage guidelines of those entities. Unauthorized use of trademarks, logos, or names may lead to legal consequences.<br/>
      7.11. Use of Designs Before Legal Clearance<br/>
      Clients are advised not to commercially use or distribute branding materials until they have obtained appropriate legal clearance confirming non-infringement.<br/>
    ...
    <p className="text-sm sm:text-base leading-relaxed">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;12.1.3. for defective products under the Consumer Protection Act 1987; or<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;12.1.4. for fraud or fraudulent misrepresentation.<br/>
      12.2. Neither party will be liable for:<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;12.2.1. loss of data or use;<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;12.2.2. any form of indirect, consequential, or special loss; or<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;12.2.3. any loss of or failure to realize expected profit, revenue, or savings, or any other form of pure economic loss, whether direct or indirect;<br/>
      and in each case, however arising.<br/>
    ...
    <p className="text-sm sm:text-base leading-relaxed">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;13.2.1. the Goods<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;13.2.2. the Services<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;13.2.3. any other products and services sold or supplied by KeepMe Lifestyle Ltd to the Client for which payment is outstanding<br/>
      13.3. Until title to the Goods has passed to the Client, the Client will:<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;13.3.1. hold the Goods as bailee for KeepMe Lifestyle Ltd;<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;13.3.2. store the Goods separately from all other goods, products or material in the Client’s possession;<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;13.3.3. take all reasonable care of the Goods and keep them in a reasonable condition;<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;13.3.4. insure the Goods: (i) with a reputable insurer (ii) from the date of delivery (iii) against all risks (iv) for an amount at least equal to their price (v) noting KeepMe Lifestyle Ltd’s interest on the policy as the payee;<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;13.3.5. ensure that the Goods are clearly identified (in a manner reasonably satisfactory to KeepMe Lifestyle Ltd) as belonging to KeepMe Lifestyle Ltd;<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;13.3.6. Inform KeepMe Lifestyle Ltd promptly if it becomes subject to any of the events set out in clause 18.1; and<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;13.3.7. promptly provide KeepMe Lifestyle Ltd with such information concerning the Goods as KeepMe Lifestyle Ltd may request from time to time.<br/>
      13.4. Notwithstanding clause 13.3, the Client may use or resell the Goods in the ordinary course of its business until such time as it becomes aware or ought reasonably to have become aware that an event specified in clause 18.1 is or is likely to occur.<br/>
      13.5. If, at any time before title to the Goods has passed to the Client, the Client informs KeepMe Lifestyle Ltd, or KeepMe Lifestyle Ltd reasonably believes, that the Client has or is likely to become subject to any of the events specified in clause 18.1, KeepMe Lifestyle Ltd may;<br/>
    ...
    <p className="text-sm sm:text-base leading-relaxed">
      ...
      14.2. The Goods will be deemed delivered:<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;14.2.1. if delivered by, or for, KeepMe Lifestyle Ltd under clause 14.1.1, on arrival of the Goods at the Delivery Location; or<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;14.2.2. if collected by the Client under clause 14.1.2, on completion of loading at KeepMe Lifestyle Ltd’s premises.<br/>
      14.3. Whilst the KeepMe Lifestyle Ltd will use reasonable endeavours to meet delivery dates, such dates are approximate only and time for delivery is not of the essence.<br/>
      14.4. KeepMe Lifestyle Ltd will not be liable for any delay in or failure of delivery caused by:<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;14.4.1. Client’s failure: (i) to make the Delivery Location available; (ii) prepare the Delivery Location as required for delivery of the Goods; or (iii) provide the KeepMe Lifestyle Ltd with adequate instructions, for delivery or otherwise relating to the Goods;<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;14.4.2. the Client’s failure to collect the Goods from the KeepMe Lifestyle Ltd’s premises; or<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;14.4.3. an event of Force Majeure.<br/>
      14.5. If the Client fails to accept delivery of, or collect, the Goods as provided in clause 14.1.1 or 14.1.2 on the date or within the period agreed with KeepMe Lifestyle Ltd:<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;14.5.1. delivery of the Goods will be deemed to have occurred at 09.00 on the second Business Day following such date/period; and<br/>
    ...
    <p className="text-sm sm:text-base leading-relaxed">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;15.3.1. needed to comply with applicable law or safety requirements; or<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;15.3.2. which do not materially affect the nature or quality of the Services; and<br/>
      15.4. KeepMe Lifestyle Ltd will provide the Services with reasonable care and skill.<br/>
      15.5. KeepMe Lifestyle Ltd will use reasonable endeavours to meet the timescales agreed for the performance of the Services. However, time will not be of the essence for such performance.<br/>
      15.6. If KeepMe Lifestyle Ltd is prevented or delayed in performing the Services by any cause attributable to the Client, KeepMe Lifestyle Ltd (without prejudice to its other rights):<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;15.6.1. may suspend performance of the Services until the Client rectifies its default;<br/>
    ...
    <p className="text-sm sm:text-base leading-relaxed">
      ...
      17.2. If, due to an event of Force Majeure, KeepMe Lifestyle Ltd:<br/>
    ...
    <p className="text-sm sm:text-base leading-relaxed">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;18.1.4. the Client passes a resolution for winding-up or for the appointment of an administrator, or a liquidator or administrator is appointed in relation to the Client, or a winding-up order is made in relation to the Client, other than solely in relation to a solvent amalgamation or reconstruction;<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;18.1.5. a receiver or administrative receiver may be or is appointed in relation to the Client or any of its assets;<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;18.1.6. any creditor of the Client attaches, takes possession of, or any distress, execution or similar process is levied or enforced against, all or any part of the Client’s assets, and such attachment or process is not discharged within 14 days;<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;18.1.7. the Client takes or suffers any action similar to any of the above in any jurisdiction;<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;18.1.8. there is a material change in the management, ownership or control of the Client;<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;18.1.9. the Client suspends trading, ceases to carry on business, or threatens to do either;<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;18.1.10. the Client is subject to an event of Force Majeure under clause 17.<br/>
      18.2. In addition to its rights under clause 18.1 KeepMe Lifestyle Ltd may terminate this Agreement at any time immediately on written notice to the Client if the Client has failed to pay any amount due under this Agreement on the due date.<br/>
      18.3. On termination of this Agreement for any reason:<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;18.3.1 the Client will immediately pay all invoices of KeepMe Lifestyle Ltd then outstanding and not disputed in good faith;<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;18.3.2. KeepMe Lifestyle Ltd will, within three Business Days, invoice the Client for all Goods delivered or provided but not yet invoiced and the Client will pay such invoice within a further three Business Days (unless the invoice is disputed in good faith);<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;18.3.3. the Client will forthwith return any materials of KeepMe Lifestyle Ltd then in its possession or control; if it fails to do so, KeepMe Lifestyle Ltd may enter onto any premises owned by or under the control of the and take possession of them;<br/>
    ...
    <p className="text-sm sm:text-base leading-relaxed">
      ...
      The parties are independent businesses and not principal and agent, partners, or employer and employee.<br/>
      19.3. Severability<br/>
      If any part of this Agreement is found by a court, tribunal or other administrative body of competent jurisdiction to be unenforceable or invalid for any reason, that provision is to be severed from this Agreement and the remaining provisions of this Agreement will otherwise remain in full force.<br/>
      19.4. Notices<br/>
      Notices under this Agreement will be in writing and sent to the persons and addresses set out at the beginning of this Agreement (or such new address notified in writing by a party to the other party) . Notices may be given, and will be deemed received:<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;19.4.1. by first-class post: two Business Days after posting<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;19.4.2. by airmail: seven Business Day after posting;<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;19.4.3. by hand: on delivery;<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;19.4.4. by facsimile: on receipt of a successful transmission report from the correct number; and<br/>
      &nbsp;&nbsp;&nbsp;&nbsp;19.4.5. by e-mail: on receipt of a delivery or read receipt mail from the correct address.<br/>
      19.5. Waiver<br/>
      No delay, act or omission by either party in exercising any right or remedy will be deemed a waiver of that, or any other, right or remedy.<br/>
      19.6. Rights of Third Parties<br/>
      This Agreement is not enforceable by any third party under the Contracts (Rights of Third Parties) Act 1999 or otherwise.<br/>
      19.7. Entire Agreement<br/>
      This Agreement constitutes the entire agreement between the parties in relation to its subject matter. No other terms apply.<br/>
      19.8. Succession<br/>
