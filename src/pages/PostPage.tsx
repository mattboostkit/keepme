...
const PostPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-4 max-w-3xl mb-16">
      ...
      <div className="mt-16 mb-16">
        <a
          href="/blog"
          className="px-5 py-2 bg-brand-pink text-white rounded-full hover:bg-[#ebbdc7] transition-colors inline-flex items-center"
        >
