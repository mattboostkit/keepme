...
const PrivacyPolicy = () => (
  <div className="container mx-auto px-4 py-12 max-w-3xl">
    ...
    <h2 className="text-2xl font-semibold mt-8 mb-4">1. Collecting Information</h2>
    <p>
    ...
    <h2 className="text-2xl font-semibold mt-8 mb-4">2. Using Your Personal Information</h2>
    <p>
    ...
    <h2 className="text-2xl font-semibold mt-8 mb-4">3. Protecting Information</h2>
    <p>
    ...
    <h2 className="text-2xl font-semibold mt-8 mb-4">4. The Internet</h2>
    <p>
    ...
    <h2 className="text-2xl font-semibold mt-8 mb-4">6. Further Information</h2>
    <p>
