...
const SanityPage: React.FC = () => {
  ...
  return (
    <div className="container mx-auto p-4 mb-16">
      <h1 className="text-4xl font-serif font-bold mb-8 text-gray-900">Posts from <span className="text-[#f4cfd9]">KeepMe</span></h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {posts.map((post) => (
          <div key={post._id} className="bg-white rounded-2xl shadow-md overflow-hidden group">
            ...
            <div className="p-6">
              <h2 className="text-xl font-bold mb-3 group-hover:text-[#f4cfd9] transition-colors">{post.title}</h2>
              {post.publishedAt && (
              ...
              {post.slug && (
                <a
                  ...
                  className="mt-4 inline-flex items-center px-5 py-2 bg-brand-pink text-white rounded-full hover:bg-[#ebbdc7] transition-colors"
                >
                  <span>Read more</span>
                </a>
              )}
